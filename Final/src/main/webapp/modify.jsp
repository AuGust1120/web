...
<table id="mytable" cellspacing="0" >
                             <tr>  
                               <th colspan="11" scope="col" style=" font-size: x-large; alignment: center">修改学生信息</th>
                             </tr>
<tr>
<td  colspan="11" style="text-align: center;">第<input name="num" style="text-align: center; border:transparent;width:25px;font-size:14px;" value="${param.stuid}">条记录</span></td></tr>
<td>学号:</td> 
<td style="text-align: left;">
<input type="text" name="stuid" value = "${param.id}">
</td></tr>
<tr>
<td>姓名:</td> 
<td style="text-align: left;">
<input type="text" name="name">
<span id="nameErrorMsg" style="color:red;visibility:hidden">姓名不能为空，长度大于2！</span>
</td></tr><tr>
<td>班级: </td><td style="text-align: left;">
...
</tr><td>上课地点: </td><td style="text-align: left;">
<input type="text" name="address">
</td></tr>
<tr><td>上课天数:</td>
<td style="text-align: left;">
<input type="checkbox" name="hobby1" value="lyou">周一<br>
<input type="checkbox" name="hobby2" value="dshan">周二<br>
<input type="checkbox" name="hobby3" value="jshen">周三<br>
<input type="checkbox" name="hobby4" value="shwang">周四<br>
<input type="checkbox" name="hobby5" value="yyong">周五<br>
<span id="hobbyErrorMsg" style="color:red;display:none">至少要选择一天</span>
</td></tr>
</tr><td>上课时间: </td><td style="text-align: left;">
