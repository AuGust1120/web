	...
	<head>
	 ...
	 <body background="img/bg3.jpg" style="background-repeat:no-repeat background-attachment:fixed;background-size:100% 100%; ">
        ...
        <table id="mytable" cellspacing="0">
                             <tr>  
                               <th colspan="11" scope="col" style=" font-size: x-large; alignment: center">上传文件</th>
                             </tr> 
            <tr>
                <td>选择文件：</td>
                <td><input type="text" name="content"><input type="file" name="f"></td>
                <td colspan="2" align="center"><input type="submit" value="选择查询"></td>
            </tr>
        </table>
    </form>
				</div>
